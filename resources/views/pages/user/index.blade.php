...
<body>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="d-flex">
                    ...
                    @if (Auth::check())
                        <a class="btn border-light text-white" href="{{ route('fe.profil') }}"
                    ...
                    @else
                        <a class="btn border-light text-white" href="{{ route('logout') }}"
                            onclick="event.preventDefault(); document.getElementById('logout-form').submit(); destroyLocalStorage()">
            ...
            <div class="col-md-12 mt-5">
                <div class="row">
                    <div class="col-md-3 mb-4 mb-md-0">
                        <ul class="list-group">
                            <li class="list-group-item bg-dark text-white"><i class='bx bx-list-ul me-2'></i><span
                                    style="font-weight: bold">Katalog</span></li>
                            @foreach ($katalog as $item)
                                <li class="list-group-item"><a
                                        href="{{ route('fe.index') }}?katalog={{ $item->nama }}"
                                        class="text-dark text-decoration-none"><i class='bx bx-chevron-right me-2'></i>
                                        {{ $item->nama }}</a></li>
                            @endforeach
                            <li class="list-group-item"><a href="{{ route('fe.index') }}"
                                    class="text-dark text-decoration-none"><i class='bx bx-chevron-right me-2'></i>
                                    Semua Katalog</a></li>
                        </ul>
                        <ul class="list-group mt-2">
                            <li class="list-group-item bg-dark text-white"><i class='bx bx-list-ul me-2'></i><span
                                    style="font-weight: bold">Cari Produk</span></li>
                            <div class="d-flex justify-content-between list-group-item">
                                <form action="#">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <button type="submit" style="width: 100%" class="btn btn-dark"><i
                        ...
                        <div id="carouselExampleCaptions" class="carousel slide">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{ asset('fe/assets/bg4.jpg') }}" class="d-block w-100"
                                        alt="..." />
                                    <div class="carousel-caption d-none d-md-block">
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('fe/assets/bg5.jpg') }}" class="d-block w-100"
                                        alt="..." />
                                    <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="carousel-item">
                                    <img src="{{ asset('fe/assets/bg6.jpg') }}" class="d-block w-100"
                                        alt="..." />
                                    <div class="carousel-caption d-none d-md-block">
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-4 d-flex justify-content-end ">
                    <div class="p-2">
                        <img class="img-fluid" src="{{ asset('fe/assets/bg7.png') }}" alt="welcome" width="300" />
                    </div>
                </div>
                <div class="col-lg-8 d-flex justify-content-start">
                    <div class="p-2">
                        <h6 class="display-6">Tentang Kami!</h6>
                        <p style="text-align:justify; line-spacing:2px">
                            <div style="word-spacing:5px" class="ms-2">
                                Optik Reka Jaya adalah pilihan terpercaya untuk kebutuhan
                                penglihatan Anda di kota Palembang. Dengan komitmen terhadap kualitas dan pelayanan, Optik
                                Reka Jaya menghadirkan berbagai produk optik yang lengkap dan terpercaya.
                            </div>
                            <div style="word-spacing:5px;" class="py-2 ms-2">
                                Menyediakan beragam pilihan frame kacamata,
                                lensa, dan aksesoris berkualitas, Optik Reka Jaya memastikan setiap pelanggan mendapatkan
                                solusi terbaik sesuai kebutuhan dan gaya hidup. Dari kacamata baca, kacamata minus, hingga
                                kacamata gaya dengan desain modern, semua tersedia dengan harga terjangkau dan layanan
    ...
    <section class="py-2 mt-5">
        <div class="container px-4 px-lg-5 mt-0">
            ...
            <div class="col-md-12">
                <div
                    class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-lg-4 d-flex justify-content-center product">
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body px-4 py-1">
                                <div class="text-center">
                                    ...
                                    <div class="border-bottom pb-2">${value.tipe}</div>
                                    <p class="mt-2">${value.keterangan}</p>
                                    <!-- Product price-->
                                </div>
                            </div>
                            <!-- Product actions-->
